...
class MedicoControllerTest {
    ...
    void cadastrar_cenario2() throws Exception {
        ...
        var dadosDetalheMedico = new DadosDetalhamentoMedico(medico);
        ...
        var jsomEsperado = dadosDetalhamentoMedicoJson
                .write(dadosDetalheMedico)
                .getJson();
        assertThat(response.getContentAsString()).isEqualTo(jsomEsperado);
    }
